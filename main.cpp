...
const char* str1 = "SAHYADRI COLLEGE OF ENGINEERING AND MANAGEMENT";
const char* str2 = "ADYAR, MANGALORE";
...
const char* str9 = "ALLAN JOSTON FERNANDES - 4SF18CS009";
const char* str10 = "YASH KORADIYA - 4SF18CS067";
const char* str11 = "DEPT OF CSE";
const char* str12 = "PROJECT GUIDED BY:";
const char* str13 = "MS. MEGHA RANI R";
...
void display4(void)
{
    ...
    bitmap_output(-5.5, 25.5, "Red Bricks Apartments", GLUT_BITMAP_TIMES_ROMAN_24);
    bitmap_output(33, 24, "House", GLUT_BITMAP_TIMES_ROMAN_24);
	bitmap_output(-43.5, -47, "But after installing SOLAR PANNEL System to the houses, then it will be useful to store power and use it for different purposes.", GLUT_BITMAP_TIMES_ROMAN_24);
